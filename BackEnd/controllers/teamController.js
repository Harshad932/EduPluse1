...
const createTeamMember = async (req, res) => {
  try {
    const { name, role, category, description, github_url, linkedin_url, image_url: fallbackImageUrl } = req.body;
...
const updateTeamMember = async (req, res) => {
  try {
    const { name, role, category, description, github_url, linkedin_url, image_url: bodyImageUrl } = req.body;
