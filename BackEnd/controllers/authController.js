...
const getAllUsers = async (req, res) => {
  try {
    ...
    const memoryCounts = {
      ...
      student: memoryUsers.filter((u) => u.role === 'student').length,
      teacher: memoryUsers.filter((u) => u.role === 'teacher').length,
